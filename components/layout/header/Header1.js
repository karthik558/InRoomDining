                                    ...
                                    <div className="cat-menu__category p-relative">
                                        ...
                                        >
                                            <ul className="cat-menu__list">
                                                <li>
                                                    <Link href="/product">
                                                        <i className="fal fa-stars" /> All Time Favorite
                                                    </Link>
                                                </li>
                                                <li>
                                                    <Link href="/product">
                                                        <i className="fal fa-sandwich" /> Sandwich
                                                    </Link>
                                                </li>
                                                <li>
                                                    <Link href="/product">
                                                        <i className="fal fa-wheat" /> Salads
                                                    </Link>
                                                </li>
                                                <li>
                                                    <Link href="/product">
                                                        <i className="fal fa-hamburger" /> Burgers
                                                    </Link>
                                                </li>
                                                <li>
                                                    <Link href="/product">
                                                        <i className="fal fa-bread-slice" /> Breads
                                                    </Link>
                                                </li>
                                                <li>
                                                    <Link href="/product">
                                                        <i className="fal fa-cookie" /> Deserts
                                                    </Link>
                                                </li>
                                                <li>
                                                    <Link href="/product">
                                                        <i className="fal fa-pizza" /> Pizza
                                                    </Link>
                                                </li>
                                                <li>
                                                    <Link href="/product">
                                                        <i className="fal fa-chess-bishop" /> Straters
                                                    </Link>
                                                </li>
                                            </ul>
                                            <div className="daily-offer">
                                                <ul>
                                                    <li>
                                                        <Link href="/product">All Time Favorite</Link>
                                                    </li>
                                                </ul>
                                            </div>
                                        </div>
